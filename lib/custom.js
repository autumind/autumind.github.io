...
============================== */
	...
	$("#content").bind("map-trigger", function(tab) {
		if (tab) {
			...
			var point = new BMap.Point(118.764,31.976); // 118.764551,31.976726
	...
	============================== */
	// Disqus功能
	$("#content").bind("comment-trigger", function(tab) {
		if (tab) {
			<script type="text/javascript">
    			/* * * CONFIGURATION VARIABLES * * */
				var disqus_shortname = 'autumind';
            ...
            if($(this).hasClass("content-list-active")){
				$(this).removeClass("content-list-active").slideUp(600, function(){
					...
					if(hasClassContact){
						...
						$(this).trigger("comment-trigger", [hasClassContact]);
					}
